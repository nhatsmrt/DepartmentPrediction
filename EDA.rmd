...
for (i in 1:136) {
  graph <- set_vertex_attr(graph, paste0("perpr_wt", i), value = page.rank(graph, personalized = V(graph)$membership_wt == i)$vector)
}
...
write.csv(df_features_train, "./Data/train.csv")
write.csv(df_features_test, "./Data/test.csv")
